...
#include "TV_EnemyArenaZone.generated.h"

UENUM(BlueprintType)
enum class EArenaTriggerMode : uint8
{
...
UCLASS()
class HOOKNFIGHT_API ATV_EnemyArenaZone : public ATriggerVolume
{
	GENERATED_BODY()
	...
	EArenaTriggerMode ArenaTriggerMode = EArenaTriggerMode::ATM_PlayerTriggersAll;
